...
class NetlistGraphDataset(Dataset):
    ...
    def process(self):
        ...
        Parallel(n_jobs=15)(delayed(preprocessGraphData)(aig_graphFiles,self.processed_dir,self.des,synthID2VecDict, id) for id in range(0, num_trainSynthesizedScript))
