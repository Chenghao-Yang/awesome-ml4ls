...
train_design = ['log2', 'cavlc', 'router', 'usb_phy']
...
class NetlistGraphDataset(Dataset):
    ...
    def processed_file_names(self):
        processedFiles = []
        for i in range(0, num_trainSynthesizedScript):
    ...
    def process(self):
        ...
        Parallel(n_jobs=20)(delayed(preprocessGraphData)(aig_graphFiles,self.processed_dir,self.des,synthID2VecDict, id) for id in range(0, num_trainSynthesizedScript))
