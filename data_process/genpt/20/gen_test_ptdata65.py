...
class NetlistGraphDataset(Dataset):
    ...
    def processed_file_names(self):
        processedFiles = []
        for i in range(70000, 70000+65000):
    ...
    def process(self):
        ...
        Parallel(n_jobs=10)(delayed(preprocessGraphData)(aig_graphFiles,self.processed_dir,self.des,synthID2VecDict, id) for id in range(70000, 70000+65000))
