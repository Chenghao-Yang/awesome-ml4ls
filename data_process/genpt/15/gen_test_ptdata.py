...
class NetlistGraphDataset(Dataset):
    ...
    def process(self):
        ...
        Parallel(n_jobs=10)(delayed(preprocessGraphData)(aig_graphFiles,self.processed_dir,self.des,synthID2VecDict, id) for id in range(217500, 250000))
